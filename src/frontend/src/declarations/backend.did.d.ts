...
export type SpinOutcome = { 'win' : number } |
  { 'loss' : number };
...
export interface _SERVICE {
  ...
  'adminDepositToPool' : ActorMethod<
    [number],
    { 'ok' : null } |
      { 'err' : string }
  >,
  'adminWithdrawFromPool' : ActorMethod<
    [number],
    { 'ok' : null } |
      { 'err' : string }
  >,
  ...
  'depositToGame' : ActorMethod<[number], { 'ok' : null } | { 'err' : string }>,
  'depositToPool' : ActorMethod<[number], { 'ok' : null } | { 'err' : string }>,
  /**
  ...
  'getGameHistory' : ActorMethod<[], Array<SpinRecord>>,
  'getGamePool' : ActorMethod<[], GamePoolInfo>,
  ...
  'getPoolOverview' : ActorMethod<[], PoolOverview>,
  ...
  'getProviderPosition' : ActorMethod<[], [] | [ProviderPosition]>,
  ...
  'sendGroupMessage' : ActorMethod<
    [bigint, MessageType, [] | [bigint], [] | [string]],
    { 'ok' : bigint } |
      { 'err' : { 'invalidDedupId' : null } | { 'duplicate' : null } }
  >,
  ...
  'spin' : ActorMethod<[number], { 'ok' : SpinResult } | { 'err' : string }>,
  ...
  'withdrawFromGame' : ActorMethod<[], { 'ok' : number } | { 'err' : string }>,
  'withdrawFromPool' : ActorMethod<[], { 'ok' : number } | { 'err' : string }>,
}
