...
export const SpinOutcome = IDL.Variant({
  'win' : IDL.Float64,
  'loss' : IDL.Float64,
});
...
export const GamePoolInfo = IDL.Record({
  'playerParticipation' : IDL.Float64,
  'pool' : IDL.Float64,
  'maxParticipation' : IDL.Float64,
});
...
export const ProviderPosition = IDL.Record({
  'provider' : IDL.Principal,
  'sharePct' : IDL.Float64,
  'profitLoss' : IDL.Float64,
  'portion' : IDL.Float64,
  'contribution' : IDL.Float64,
});
export const PoolOverview = IDL.Record({
  'totalProviders' : IDL.Nat,
  'ownPosition' : IDL.Opt(ProviderPosition),
  'totalPoolValue' : IDL.Float64,
});
...
export const idlService = IDL.Service({
  ...
  'adminDepositToPool' : IDL.Func(
      [IDL.Float64],
      [IDL.Variant({ 'ok' : IDL.Null, 'err' : IDL.Text })],
      [],
    ),
  'adminWithdrawFromPool' : IDL.Func(
      [IDL.Float64],
      [IDL.Variant({ 'ok' : IDL.Null, 'err' : IDL.Text })],
      [],
    ),
  ...
  'depositToGame' : IDL.Func(
      [IDL.Float64],
      [IDL.Variant({ 'ok' : IDL.Null, 'err' : IDL.Text })],
      [],
    ),
  'depositToPool' : IDL.Func(
      [IDL.Float64],
      [IDL.Variant({ 'ok' : IDL.Null, 'err' : IDL.Text })],
      [],
    ),
  ...
  'getGameHistory' : IDL.Func([], [IDL.Vec(SpinRecord)], ['query']),
  'getGamePool' : IDL.Func([], [GamePoolInfo], ['query']),
  ...
  'getPoolOverview' : IDL.Func([], [PoolOverview], ['query']),
  ...
  'getProviderPosition' : IDL.Func([], [IDL.Opt(ProviderPosition)], ['query']),
  ...
  'sendGroupMessage' : IDL.Func(
      [IDL.Nat, MessageType, IDL.Opt(IDL.Nat), IDL.Opt(IDL.Text)],
      [
        IDL.Variant({
          'ok' : IDL.Nat,
          'err' : IDL.Variant({
            'invalidDedupId' : IDL.Null,
            'duplicate' : IDL.Null,
          }),
        }),
      ],
  ...
  'spin' : IDL.Func(
      [IDL.Float64],
      [IDL.Variant({ 'ok' : SpinResult, 'err' : IDL.Text })],
      [],
    ),
  'transform' : IDL.Func(
      [TransformationInput],
  ...
  'withdrawFromGame' : IDL.Func(
      [],
      [IDL.Variant({ 'ok' : IDL.Float64, 'err' : IDL.Text })],
      [],
    ),
  'withdrawFromPool' : IDL.Func(
      [],
      [IDL.Variant({ 'ok' : IDL.Float64, 'err' : IDL.Text })],
      [],
    ),
...
export const idlFactory = ({ IDL }) => {
  ...
  const ProviderPosition = IDL.Record({
    'provider' : IDL.Principal,
    'sharePct' : IDL.Float64,
    'profitLoss' : IDL.Float64,
    'portion' : IDL.Float64,
  ...
  return IDL.Service({
    ...
    'getPosts' : IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(Post)], ['query']),
    'getPostsFromFollowedUsers' : IDL.Func([], [IDL.Vec(Post)], ['query']),
    'getProviderPosition' : IDL.Func(
        [],
        [IDL.Opt(ProviderPosition)],
        ['query'],
      ),
    'getRoseBalance' : IDL.Func([], [IDL.Float64], ['query']),
    'getRoseSummary' : IDL.Func(
